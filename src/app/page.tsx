        ...
        <MaxWidthWrapper className="lg:grid grid-cols-3 lg:pb-20">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                CaseMyPhone allows you to protect your memories, not just your
                phone case.
              </p>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              />
              <Phone className="w-64" imgSrc="/testimonials/5.jpg" />
            </div>
          </div>
          {/* Grid Right (End) */}
        </MaxWidthWrapper>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              ...
              <span className="relative px-2">
                customers{" "}
                <SquigglyLine.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-red-500" />
              </span>{" "}
              say
            </h2>
          </div>
